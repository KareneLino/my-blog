 ...
 * 
 * 层级：第一层级（导航页）
 * 布局：使用 ManagementLayout，无 FilterBar
 */
export function Dashboard() {
  ...
  return (
    <ManagementLayout
      ...
      headerActions={
        <button className="px-4 py-2 text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <Card 
            key={stat.label} 
            hoverable 
            animated={false}  // 禁用入场动画，避免与 Outlet 动画叠加
          ...
          >
            ...
            <div className="mt-6 space-y-2">
              <div className="text-4xl font-bold font-serif tracking-tight text-zinc-900 dark:text-zinc-50">
                {stat.value}
              </div>
      ...
      {/* 图表区域 */}
      <Card animated={false} className="p-8 mt-8">
